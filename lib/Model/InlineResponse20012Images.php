...
/**
 * InlineResponse20012Images Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20012Images implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_12_images';
     ...
     * Sets id
     *
     * @param float $id id картинки в базе
     *
     * @return $this
     */
     ...
     * Sets x90
     *
     * @param string $x90 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x180
     *
     * @param string $x180 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x180x132
     *
     * @param string $x180x132 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x250
     *
     * @param string $x250 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x290x135
     *
     * @param string $x290x135 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x245x240
     *
     * @param string $x245x240 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x500
     *
     * @param string $x500 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x900
     *
     * @param string $x900 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x55x56
     *
     * @param string $x55x56 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x100x115
     *
     * @param string $x100x115 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x170x100
     *
     * @param string $x170x100 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x310
     *
     * @param string $x310 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x270x150
     *
     * @param string $x270x150 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x270x200
     *
     * @param string $x270x200 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x620
     *
     * @param string $x620 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x800x600
     *
     * @param string $x800x600 ссылка на картинку данного размера
     *
     * @return $this
     */
     ...
     * Sets x800x600x
     *
     * @param string $x800x600x ссылка на картинку данного размера
     *
     * @return $this
     */
