...
/**
 * InlineResponse2003SearchParamsToCountry Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2003SearchParamsToCountry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_3_search_params_to_country';
     ...
     * Sets id
     *
     * @param int $id ID Плейса страны назначения в системе
     *
     * @return $this
     */
