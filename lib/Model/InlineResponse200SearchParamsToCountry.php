<?php
/**
 * InlineResponse200SearchParamsToCountry
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse200SearchParamsToCountry Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse200SearchParamsToCountry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_search_params_to_country';
     ...
     * Sets id
     *
     * @param int $id ID страны прилета
     *
     * @return $this
     */
     ...
     * Sets iso2
     *
     * @param string $iso2 ISO2 страны прилета
     *
     * @return $this
     */
     ...
     * Sets thumb
     *
     * @param string $thumb Ссылка на фото
     *
     * @return $this
     */
