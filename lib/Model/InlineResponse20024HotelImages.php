<?php
/**
 * InlineResponse20024HotelImages
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse20024HotelImages Class Doc Comment
 *
 * @category Class
 * @description Фото
 * @package  Swagger\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20024HotelImages implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_24_hotel_images';
     ...
     * Sets id
     *
     * @param int $id ID фото в системе
     *
     * @return $this
     */
     ...
     * Sets x900
     *
     * @param string $x900 Абсолютная ссылка на фото
     *
     * @return $this
     */
